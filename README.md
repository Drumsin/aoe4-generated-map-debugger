...
Commonly named variables from the map generation starter template. Defined for speed and efficiency in testing with tool. You still need to define these variables in your map scar code. See example below:
* `mapHalfSize`
* `mapQuarterSize`
* `mapEighthSize`
